...
#loading the data
C=npy.load("Data For Assignment GREEN/C.npy")
y=npy.load("Data For Assignment GREEN/y.npy")
A_inv=npy.load("Data For Assignment GREEN/A_inv.npy")
...
# result i:e an optimal solution (column vector will be obtained) verbose=True helped track the steps while the prob.solve was running
...
#contents were saved
npy.save("ans_s_green.npy",s)
npy.save("ans_x_green.npy",x)

...
#loading the data
C=npy.load("Data For Assignment BLUE/C.npy")
y=npy.load("Data For Assignment BLUE/y.npy")
A_inv=npy.load("Data For Assignment BLUE/A_inv.npy")
...
#contents were saved
npy.save("ans_s_blue.npy",s)
npy.save("ans_x_blue.npy",x)
